...
-- MAGIC 2. results.json Bronze folder path - abfss://bronze@datbrickscourseucextdl.dfs.core.windows.net
...
USING json
OPTIONS (path "abfss://bronze@datbrickscourseucextdl.dfs.core.windows.net/drivers.json");
...
USING json
OPTIONS (path "abfss://bronze@datbrickscourseucextdl.dfs.core.windows.net/results.json");
